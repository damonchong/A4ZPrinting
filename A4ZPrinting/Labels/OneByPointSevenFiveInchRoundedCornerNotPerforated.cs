...
namespace A4ZPrinting.Labels
{
   ...
   */
  public class OneByPointSevenFiveInchRoundedCornerNotPerforated : AbstractRoundedCornerLabel
  {
    ...
    public OneByPointSevenFiveInchRoundedCornerNotPerforated(ITemplate t)
    {
      Template = t;
      if (!VerifyTemplate())
      {
